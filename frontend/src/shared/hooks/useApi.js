...
export const useApi = (options = {}) => {
  ...
  }, [setLoading, setError, setData, setProgress, showToast, successMessage, addToast, getErrorMessage])
  ...
  }, [setSubmitting, setError, setData, setProgress, showToast, addToast, getErrorMessage])
  ...
  }, [setLoading, setError, setData, showToast, addToast, getErrorMessage])
  ...
  const upload = useCallback(async (apiCall, formData, options = {}) => {
    ...
    try {
      ...
      const message = getErrorMessage(error, customErrorMessage || 'Failed to upload file')
      setError(message)
      setUploadProgress(0)
  ...
  }, [setUploading, setError, setData, setUploadProgress, showToast, addToast, getErrorMessage])
  ...
  const download = useCallback(async (apiCall, args = [], options = {}) => {
    ...
    try {
      ...
      const message = getErrorMessage(error, customErrorMessage || 'Failed to download file')
      setError(message)
      setProgress(0)
  ...
  }, [setLoading, setError, setProgress, showToast, addToast, getErrorMessage])
