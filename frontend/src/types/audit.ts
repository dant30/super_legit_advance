...
export type AuditAction = 
  ...
  | 'APPROVE' | 'REJECT' | 'VERIFY' | 'BLACKLIST'
  | 'ACTIVATE' | 'DEACTIVATE' | 'PAYMENT' | 'REFUND'
  | 'NOTIFICATION' | 'REPORT' | 'BACKUP' | 'RESTORE'
...
export interface AuditSummary {
  ...
  failure_logs: number
  success_rate: number
  severity_distribution: Array<{ severity: AuditSeverity; count: number }>
...
export interface SecurityEvent extends AuditLog {
  event_type: 'LOGIN_ATTEMPT' | 'FAILED_LOGIN' | 'PASSWORD_CHANGE' | 'PERMISSION_CHANGE' | 'SUSPICIOUS_ACTIVITY'
  description: string
